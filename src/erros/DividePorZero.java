...
public class DividePorZero {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * printStackTrace(); - imprime a pilha de erro encontrada nessa exessão  diretamente no sistema
		 * 
		 * getStackTrace(); -  recebe um array dos erros identificados para realizar o tratamento
		 * 
		 * getMessage(); - retorna uma msg em geral contendo a lista de erros no formato string
		 * 
